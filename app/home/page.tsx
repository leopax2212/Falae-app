...
export default function HomePage() {
  ...
  useEffect(() => {
    const inscribedEventId = localStorage.getItem("inscribedEventId")
    ...
    if (inscribedEventId) {
      // Load inscribed event details (you can fetch from BFF if needed)
      setScheduledEvent({
        id: parseInt(inscribedEventId),
        type: "Encontro",
        date: "Data do evento",
        time: "Horário",
        location: "Local",
  ...
  const handleCancel = () => {
    localStorage.removeItem("inscribedEventId")
